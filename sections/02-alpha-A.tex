...
\item[-ani]\label{m:-ani}
	...
	\item	unclear meaning in a handful of nouns, a few of which seem to be derived from verbs
		...
		\item	\fm{gwéinlani} ‘hoof’
			...
			see the entry for the fossilized instrument suffix \X{-l};
		...
		\item	\fm{g̱alnáatʼani} ‘bundle (for carrying)’
			...
			\newline
			or possibly the same root \fm{\rt{.atʼ}} as \fm{yana.áatʼani} above
		\end{itemize}
	\end{enumerate}
