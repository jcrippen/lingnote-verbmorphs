...
\item[-áchʼ]\label{m:-áchʼ}
	...
	\item	\fm{g̱eeg̱áchʼ} \~\ \fm{g̱eig̱áchʼ} ‘hammock, swing for baby’
		...
		\item	\fm{g̱eeg̱áchʼaa} \~\ \fm{g̱eig̱áchʼaa} ‘swing’
			...
			This form implies verb → noun → verb → noun.
		\end{itemize}
...
\item[-álʼ]\label{m:-álʼ}
	...
	This form is attested only with two verbs but may be possible with others given various
		nouns that apparently include this form of the suffix.
	\begin{enumerate}
