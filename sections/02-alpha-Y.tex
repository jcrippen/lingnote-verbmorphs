...
\item[ÿaa=]\label{m:ÿaa=mind}
	...
	The \fm{ÿaa=} ‘mental’ preverb can occur together with the \X[ÿaa=along]{ÿaa=} ‘along’
		directional preverb; see \ref{item:ÿaa=ment-confusion} below.
	...
	\item	\label{item:ÿaa=ment-confusion}
		...
		\item	\vbform{du daa yaa ḵux̱wlig̱át}{pfv}[subj intr, \fm{∅}, ach]{I made him/her dizzy}
			...
			\versus \vbform{ḵaa daa yaa ḵulag̱átch}{hab}{it makes people pass out}
			\parencite[149.1972]{story-naish:1973}
				\vbmorph{ḵaa&daa&\gm{ÿaa=}&ḵu-&u-&la-&\rt{g̱aᴴt}&-μH&-ch}
					{\xx{ind.h.poss}&around&\xx{ment}&\xx{areal}&\xx{zpfv}&\xx{csv}&\rt{scattered}&\·\xx{var}&\·\xx{rep}}
		\item	\vbform{ax̱ daa yaa ḵusag̱átx̱}{rep impfv}[subj intr, \fm{∅}, ach]{it repeatedly makes me dizzy}
			...
			\versus \vbform{ḵaa daa yaa ḵusagátch}{hab}{it confuses people}
			\parencite[54.602]{story-naish:1973}
				\vbmorph{ḵaa&daa&\gm{ÿaa=}&ḵu-&u-&sa-&\rt{g̱aᴴt}&-μH&-ch}
					{\xx{ind.h.poss}&around&\xx{ment}&\xx{areal}&\xx{zpfv}&\xx{csv}&\rt{scattered}&\·\xx{var}&\·\xx{rep}}
			\newline
		...
		\item	\fm{yaa ḵuwdlig̱áat}{pfv}[subj intr, \fm{n}?, mot]{she/he/it wandered in a daze}
			\parencite[827]{leer:1976}
	...
	\item	\label{item:ÿaa=ment-offense}
		Verbs that denote causing offense or making mistakes based on \fm{\rt{g̱aᴴt}}
			‘fall scattered’.
		These are similar to the verbs of confusion in \ref{item:ÿaa=ment-confusion}
			but replace the noun phrase \fm{du daa} ‘his/her around’ with
			one based on the noun \fm{niÿaa} ‘direction’, usually contracted to
			either \fm{…nyaa} or \fm{…naa} with a prefixed body part noun
			(\fm{x̱ʼa-} ‘mouth’, \fm{ji-} ’hand’, \fm{ÿa-} ‘face’).
		The \fm{ÿaa=} ‘mental’ may fail to occur for some speakers or it may appear
			...
			syllables into one (haplology), thus \fm{x̱ʼanaa yaa=} may become
	...
	\item	\label{item:ÿaa=ment-stingy}
		...
		\end{itemize}
	\item	The preverb \fm{ÿaa=} ‘mental’ does not occur anywhere else.
		Internal reconstruction suggests a form like \fm[*]{ŋaːʰ}.
