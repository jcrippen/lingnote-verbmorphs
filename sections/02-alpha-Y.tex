...
\item[ÿaa=]\label{m:ÿaa=mind}
	...
	\begin{enumerate}
	\item	Verbs of intelligence based on \fm{\rt{ge}} ‘smart, wise, intelligent’.
		\begin{itemize}
		...
		\end{itemize}
	\item	Verbs of confusion based on \fm{\rt{g̱at}} ‘fall scattered’.
		\begin{itemize}
		\item	\fm{yaa aḵoowlig̱át} (pfv; tr, \fm{∅}, ach) ‘s/he/it forgot him/her/it’
		\end{itemize}
	\item	Perhaps in verbs for being stingy or unsharing based on \fm{\rt{ge}} ‘stingy’.
		\begin{itemize}
		...
		\end{itemize}
	\end{enumerate}
	Although \fm{ÿaa=} ‘mental’ is peculiar, it seems to reflect similar patterns in other Na-Dene
	...
	Within Tlingit, \fm{ÿaa=} ‘mental’ may be potentially related to one or more of the roots
		\begin{inlinelist}
