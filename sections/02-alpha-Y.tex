...
\item[yóo=]\label{m:yóo=away}
	...
	\item	\label{item:yóo=quot-mot}
		...
		\item	\label{item:yóo=quot-mot-x̱}
			...
			\begin{itemize}
			\item	\vbform{du hídináx̱ yóox̱ yaa yanas.éin}{prog}{he is peeping out from his house}
				\parencite[147.1998]{story-naish:1973}
					\vbmorph{\gm{yóo}&\gm{-x̱=}&ÿaa=&ÿa-&na-&sⱥ-&\rt[¹]{.a}&-μμᵉH&-n}
						{out&\·\xx{pert}&along&face&\xx{ncnj}&\xx{xtn}&\rt[¹]{end.move}&\·\xx{var}&\·\xx{nsfx}}
			\item	\vbform{tléil yóox̱ eeltoox̱úḵ}{phib impfv}{don’t spit it out}
	...
	\item	Forms where \fm{yóo=} occurs without any postpositions.
		...
		\item	\vbform{yóo naalée}{impfv}[obj intr, \fm{n}, \fm{-μμH} state]{it is far away}
			...
			\parencite[20.210]{nyman-leer:1993}
				\vbmorph{ḵaa&ít&\gm{yóo=}&na-&μ-&\rt[¹]{li}&-μL&-i&yéi}
