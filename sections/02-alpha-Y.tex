...
\item[ÿaa=]\label{m:ÿaa=mind}
	...
	The \fm{ÿaa=} ‘mental’ preverb can occur together with the \X[ÿaa=along]{ÿaa=} ‘along’
		directional preverb as evidenced by the form 
		\vbform{ÿaa ÿaa ḵunx̱alg̱át}{prog}{I am wandering along lost, in a daze}
		detailed in \ref{item:ÿaa=ment-confusion} below.
	...
	\item	\label{item:ÿaa=ment-smart}
		...
		All documented verbs based on this root include \fm{ÿaa=} ‘mental’ in all forms
			as well as areal \X[ḵu-areal]{ḵu-} suggesting some kind of mental space.
		\begin{itemize}
		...
		\item	\vbform{du daa yaa x̱at ḵushusigéi}{impfv}[obj intr, \fm{g}, \fm{-μμH} state]{she/he understands me}
			...
			Alternatively, this verb may vary among speakers so that some have it as
				impersonal where others have it with an object.
...
\item[yux̱=]\label{m:yux̱=}
	...
	Seems to have been derived from the distal deictic \fm{yú} \~\ \fm{yóo} ‘there (far)’
	...
	The difference between \fm{yux̱=} and \fm{yóo-x̱} may arise out of different
		motion derivations.
	Thus \fm{yux̱=} likely derives from the motion derivation
		\motderiv{NP-x̱}{n, \fm{yoo=i-…-k} rep}{along NP}
		with \fm{yú} as the noun phrase
		whereas \fm{yóo-x̱} derives from the motion derivation
		\motderiv{NP-t/x̱/dé}{∅, \fm{-μμL} rep}{arriving at NP}
		with \fm{yú} as the noun phrase.
	The difference in length between \fm{yux̱=} and \fm{yóo-x̱} may be because
	...
	\item	Motion verbs with the motion derivation
		...
		\begin{itemize}
		\item	\fm{yux̱ naltlʼeet}
			\parencite[015.347]{dauenhauer-dauenhauer:1987}
		\item	\fm{yux̱ wujixeex}
	...
	\item	Motion verbs with the motion derivation
			...
			restricted to nouns ending with a [\ipa{CV́}] syllable.
		\begin{itemize}
		\item	\fm{áa yux̱ woogoot}
			\parencite[255.10]{swanton:1909}
		\item	\fm{kʼé áa yux̱ nagú}
			\parencite[287.5]{swanton:1909}
		\item	\fm{áa yux̱ aawagoot}
			\parencites[287.12]{swanton:1909}[003.409]{dauenhauer-dauenhauer:1987}
		\item	\fm{áa yux̱ aawa.aat}
			\parencite[287.11]{swanton:1909}
		\item	\fm{áa yux̱ nalnúkch}
			\parencite[011.206]{dauenhauer-dauenhauer:1987}
		\item	\fm{áa yux̱ wujixeex}
			\parencites[283.1]{swanton:1909}[016.196]{dauenhauer-dauenhauer:1987}[031.478]{nyman-leer:1993}
		\item	\fm{áa yux̱ awdlig̱ein}
	...
	\item	Motion verbs with the motion derivation
			...
			\fm{-í} \~\ \fm{-i} restricted to preverbal PPs.
		\begin{itemize}
		\item	\fm{gáani yux̱ woogoot}
			\parencite[017.54]{dauenhauer-dauenhauer:1987}
		\item	\fm{Gáani yux̱ yaa yanas.éini}
			\parencite[015.336]{dauenhauer-dauenhauer:1987}
		\item	\fm{gáani yux̱ kawdudli.oo}
			\parencite[257.4]{swanton:1909}
		\item	\fm{gáani yux̱ has aawax̱óotʼ}
			\parencite[285.8]{swanton:1909}
		\item	\fm{x̱áni yux̱ woogoot}
			\parencite[259.8]{swanton:1909}
		\item	\fm{hasdu x̱áni yux̱ nag̱asheex}
			\parencite[286.13]{swanton:1909}
		\item	\fm{éig̱i yux̱ wutuwax̱óotʼ}
	...
	\item	Motion verbs with the motion derivation 
		...
		\begin{itemize}
		\item	\fm{anax̱ yux̱ woogoot}
			\parencite[011.376]{dauenhauer-dauenhauer:1987}
		\item	\fm{Anax̱ yux̱ jiwdigoot}
			\parencite[032.291]{nyman-leer:1993}
		\item	\fm{a ítnáx̱ áwé yux̱ jiwdigoot}
			\parencite[032.301]{nyman-leer:1993}
		\end{itemize}
	\item	Motion verbs with the motion derivation 
			\motderiv{yux̱=}{n, \fm{yoo=i-…-k} rep}{out, outside}
		...
		\begin{itemize}
		\item	\fm{yú hít yeedáx̱ yux̱ wu.aadí}
			\parencite[015.258]{dauenhauer-dauenhauer:1987}
		\end{itemize}
	\end{enumerate}
\end{morphdesc}
