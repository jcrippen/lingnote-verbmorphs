...
\item[ÿeeḵ=]\label{m:ÿeeḵ=}
	Variant form of directional preverb \X{ÿeiḵ=} ‘beach‘ used in some Southern Tlingit varieties.
	The \fm{ÿeiḵ=} form arises from uvular lowering of \fm{ee} [\ipa{ìː}] to \fm{ei} [\ipa{èː}]
		when preceded or followed by a uvular consonant.
	Although \fm{ÿeeḵ=} is the more conservative form, \fm{ÿeiḵ=} is better documented and
