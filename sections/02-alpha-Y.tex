...
\item[ÿaa=]\label{m:ÿaa=mind}
	...
	Logically the \fm{ÿaa=} ‘mental’ preverb could occur together with the
		\X[ÿaa=along]{ÿaa=} ‘along’ directional preverb but there are no attested
	...
	\item	\label{item:ÿaa=ment-confusion}
		Verbs of confusion based on \fm{\rt{g̱at}} ‘fall scattered’.
		\begin{itemize}
