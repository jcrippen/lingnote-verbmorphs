...
\item[haa=]\label{m:haa=here}
	...
	\item	In a few other contexts where it occurs in interjections and
		...
		\item	\fm{shkʼaandé} ‘give it here’
			...
			from \fm{shkʼé} and \fm{haandé}
		\end{itemize}
	\end{enumerate}

\item[haadé=]\label{m:haadé=}
	Allomorph of the directional preverb \X[haa=here]{haa=} ‘here, hither’
...
\item[haandé=]\label{m:haandé=}
	...
	\item	In motion verbs with the motion derivation
			...
			prospective or progressive.
		\begin{itemize}
		\item	\vbform{Haandé kg̱wagóot wé i éekʼ}{prog}[subj intr, \fm{∅}, mot]{your brother is coming here}
			\parencite[178.246]{dauenhauer-dauenhauer:1987}
				\vbmorph{\gm{haan}&\gm{-dé}=&k-&ʷ-&g̱a-&\rt[¹]{gut}&-μμH}
					{here&\·\xx{all}&\xx{gcnj}&\·\xx{irr}&\xx{mod}&\rt[¹]{go.\xx{sg}}&\·\xx{var}}
		\item	\vbform{tlél tsu yáa haandé kg̱eegóot}{prosp}[subj intr, \fm{∅}, mot]{you’ll never come back here}
			\parencite[120.427]{nyman-leer:1993}
				\vbmorph{tlél&tsu&yá&-μ&\gm{haan}&\gm{-dé}&k-&ʷ-&g̱a-&i-&\rt[¹]{gut}&-μμH}
					{\xx{neg}&again&\xx{prox}&\·\xx{loc}&here&\·\xx{all}&\xx{gcnj}&\·\xx{irr}&\xx{mod}&\xx{2sg.s}&\rt[¹]{go.\xx{sg}}&\·\xx{var}}
		\end{itemize}
	\item	In other verbs with the motion derivation
			\motderiv{haat= / haax̱= / haa(n)dé=}{∅, \fm{-μμL} rep}{arriving at NP}
			when the aspect of the verb is either
			prospective or progressive.
		\begin{itemize}
		\item	\vbform{haandé jinahaayín}{past prog}[obj intr, \fm{∅}, mot]{they were imported from over there}
			lit.\ ‘they used to arrive here’
			\parencite[174.163]{dauenhauer-dauenhauer:1987}
				\vbmorph{\gm{haan}&\gm{-dé}&ji-&na-&\rt[¹]{ha}&-μμL&-ÿín}
					{here&\·\xx{all}&hand&\xx{ncnj}&\rt[¹]{appear}&\·\xx{var}&\·\xx{past}}
		\end{itemize}
	\item	As a postposition phrase in other contexts.
		\begin{enumerate}
		\item	With verbs that do not reflect the motion derivation
				\motderiv{haat= / haax̱= / haa(n)dé=}{∅, \fm{-μμL} rep}{arriving at NP}
				so that \fm{haandé} is an adjunct postposition phrase.
			These are particularly identified by the appearance of \fm{haandé}
				when the aspect of the verb is neither
				prospective or progressive.
			\begin{itemize}
			\item	\vbform{Kichx̱áandáx̱ haandé kaawaháa}{pfv}[obj intr, \fm{∅}, mot]{it happened on the near side of Ketchikan}
				lit.\ ‘it appeared here from Ketchikan’
				\parencite[220.40]{dauenhauer-dauenhauer:1987}
					\vbmorph{Kichx̱áan&-dáx̱&\gm{haan}&\gm{-dé}&ka-&μw-&wa-&\rt[¹]{ha}&-μμH}
						{Ketchikan&\·\xx{abl}&here&\·\xx{all}&\xx{qual}&\xx{pfv}&\xx{stv}&\rt[¹]{appear}&\·\xx{var}}
			\item	\vbform{haandé haa kawduwaḵáa}{pfv}[tr, \fm{∅}, \fm{u-…-μH} act]{they told us (to come) this way}
				\parencite[168.5]{nyman-leer:1993}
					\vbmorph{\gm{haan}&\gm{-dé}&haa=&ka-&w-&du-&wa-&\rt[¹]{ḵa}&-μμH}
						{here&\·\xx{all}&\xx{1pl.o}&\xx{qual}&\xx{pfv}&\xx{ind.h.s}&\xx{stv}&\rt[¹]{say}&\·\xx{var}}
			\end{itemize}
		\item	In phrases and sentences without a verb.
			\begin{itemize}
			\item	\fm{haandé i jín!} ‘shake hands!’ lit.\ ‘hither, your hand!’
				\parencites[01/48]{leer:1973}[146.997]{nyman-leer:1993}[10]{dauenhauer-dauenhauer:2002}
			\item	\fm{shkʼaandé} ‘give it here’
			...
			\item	\fm{Ha, haandé déi!} ‘Well, come over now!’ lit. ‘well, hither, now’
				\parencite[118.180]{dauenhauer-dauenhauer:1987}
			\item	\fm{Haandé ax̱ shóode, ax̱ káani yán!} ‘Come here for me, my brothers-in-law!’
				lit.\ ‘hither, to the end of me, my brothers-in-law!’
				\parencite[122.13]{dauenhauer-dauenhauer:1987}
			\item	\fm{Haandé wé dáanaa} ‘Give me the money’ lit.\ ‘hither, the money’
...
\item[haax̱=]\label{m:haax̱=}
	Allomorph of the directional preverb \X[haa=here]{haa=} ‘here, hither’
		with the pertingent postposition \fm{-x̱} ‘at, of, contacting’.
	Derived from \fm{haa=} and the motion derivation
		\motderiv{NP-t/x̱/dé}{∅, \fm{-μμL} rep}{arriving at NP}
		with the pertingent postposition used for repetitive imperfective aspect forms.
	\begin{enumerate}
	\item	In motion verbs with the motion derivation
			\motderiv{haat= / haax̱= / haa(n)dé=}{∅, \fm{-μμL} rep}{arriving at NP}
			when the aspect of the verb is repetitive imperfective.
		\begin{itemize}
		\item	\vbform{haax̱ goot}{rep impfv}[subj intr, \fm{∅}, mot]{he frequently comes here}
			\parencite[351.3618]{story-naish:1973}
				\vbmorph{\gm{haa}&\gm{-x̱=}&\rt[¹]{gut}&-μμL}
					{here&\·\xx{pert}&\rt[¹]{go.\xx{sg}}&\·\xx{var}}
			\versus \vbform{tléil haax̱ ugoot}{rep impfv}{he doesn’t come here}
			\parencite[352.3620]{story-naish:1973}
				\vbmorph{tléil&\gm{haa}&\gm{-x̱=}&u-&\rt[¹]{gut}&-μμL}
					{\xx{neg}&here&\·\xx{pert}&\xx{irr}&\rt[¹]{go.\xx{sg}}&\·\xx{var}}
		\item	\vbform{haax̱ dul.aat}{rep impfv}[tr, \fm{∅}, mot]{they are bringing them back (hides)}
			\parencite[54.245]{nyman-leer:1993}
				\vbmorph{\gm{haa}&\gm{-x̱=}&du-&d-&l-&\rt[¹]{.at}&-μμL}
					{here&\·\xx{pert}&\xx{ind.h.s}&\xx{mid}&\xx{csv}&\rt[¹]{go.\xx{sg}}&\·\xx{rep}}
		\item	\vbform{ldakát yéináx̱ áwé haax̱ dunook óoxjaa}{rep impfv}[tr, \fm{∅}, mot]{the wind blows from every direction}
			lit.\ ‘it is through every way that people feel it, wind’
			\parencite[32.254]{story-naish:1973}
				\vbmorph{\gm{haa}&\gm{-x̱=}&du-&\rt[²]{nuk}&-μμL}
					{here&\·\xx{pert}&\xx{ind.h.s}&\rt[²]{feel}&\·\xx{var}}
		\end{itemize}
	\end{enumerate}
