...
\item[-μ]\label{m:-μ-loc}
	...
	% No examples here.
	\begin{enumerate}
	\item	Part of the inceptive manner preverb 
		\X{g̱unayéi=} ‘starting, beginning’
		and its allomorphs \X{g̱unéi=} and \X{g̱unyéi=},
		derived from the locational noun \fm{g̱unayé} ‘different place, elsewhere’.
	\item	Part of the locational preverb
		\X{áa=} ‘there, at it’,
		derived from the third person nonhuman pronoun \fm{á} ‘it’.
	\item	Part of the locational preverb
		\X{shóo=} ‘in front of, at the end of’,
		derived from the spatial noun \fm{shú} ‘end, tip’.
	\end{enumerate}
