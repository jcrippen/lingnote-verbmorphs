	...
	\item	suffix in verbs with the extraordinary state derivation outlined above
		...
		\item	\fm{–.áax̱chʼán} ‘fascinating to hear’
			...
			\versus \vbform{aawa.áx̱}{pfv}[tr, \fm{∅}, ach]{she/he/it heard him/her/it}
				\vbmorph{a-&μʷ-&wa-&\rt[²]{.ax̱}&-μH}
					{\xx{3>3}&\xx{pfv}&\xx{stv}&\rt[²]{hear}&\·\xx{var}}
		\item	\fm{–g̱éiḵchʼán} ‘pitiable’
			from \fm{\rt[¹]{g̱iḵ}} \~\ \fm{\rt[¹]{g̱eḵ}} ‘merciful; stingy’ in
			\newline
			\vbform{tulig̱éiḵchʼán}{impfv}[obj intr, \fm{g}?, inv state]{she/he/it is pitiable}
			\parencite[7]{leer:1995b}
				\vbmorph{tu-&l-&i-&\rt[¹]{g̱eḵ}&-μμH&-\gm{chʼán}}
					{inside&\xx{xtn}&\xx{stv}&\rt[¹]{merciful}&\·\xx{var}&\·\xx{intns}}
			\versus
			\vbform{tulig̱eiḵ}{impfv}[obj intr, \fm{g}?, inv? state]{she/he/it is compassionate, merciful}
			\parencite[f02/196]{leer:1973}[848]{leer:1976}
				\vbmorph{tu-&l-&i-&\rt[¹]{g̱eḵ}&-μμL}
					{inside&\xx{xtn}&\xx{stv}&\rt[¹]{merciful}&\·\xx{var}}
		...
		\item	\fm{-chʼán} is specifically attested with the roots:
			\begin{inlinelist}
			\item	\fm{\rt{.ax̱}} ‘hear’
			\item	\fm{\rt{g̱eḵ}} \~\ \fm{\rt{g̱iḵ}} ‘merciful; stingy’
