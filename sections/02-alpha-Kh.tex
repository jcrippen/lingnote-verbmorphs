...
\item[ḵwáaḵ=]\label{m:ḵwáaḵ=}
	...
	\end{allolist}
	\begin{enumerate}
	\item	Forms with the punctual postposition \fm{-t}.
		\begin{itemize}
		\item	\vbform{ḵwáaḵt yee wuneiyí}{sub pfv}[obj intr, \fm{∅}, ach]{if an accident happens to you}
		...
		\item	\vbform{ḵwáaḵt wudzigít}{pfv}[subj intr, \fm{∅}, ach]{he made a mistake}
			\parencite[24]{leer:1963}[658]{leer:1976}
		...
		\item	\vbform{ḵwáaḵt yaawaḵáa}{pfv}[subj intr, \fm{∅}, \fm{x̱ʼa-…-μH} act]{she/he spoke wrong}
			...
			\parencite[857]{leer:1976}
				\vbmorph{\gm{ḵwáaḵ}&\gm{-t=}&ash=&ÿa-&w-&s-&i-&\rt[¹]{ḵa}&-μμH}
					{wrong&\·\xx{pnct}&\xx{qual}&\xx{3prx.o}&\xx{pfv}&\xx{csv}&\xx{stv}&\rt[¹]{say}&\·\xx{var}}
		\end{itemize}
	\item	Forms with the pertingent postposition \fm{-x̱}.
		\begin{itemize}
