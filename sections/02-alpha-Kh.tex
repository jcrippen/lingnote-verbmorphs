...
\item[ḵux̱=]\label{m:ḵux̱=}
	...
	\item	With motion verbs using the motion derivation
		...
		\item	Object intransitive motion verbs where the \X{d-} middle voice prefix
			...
			\item	\vbform{ḵúx̱de x̱at kagux̱dayáa}{prosp}[obj intr, \fm{∅}, mot]{I will travel back (here)}
				\parencite[233.3318]{story-naish:1973}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&x̱at=&ka-&g-&u-&x̱-&\gm{da-}&\rt[¹]{ÿa}&-μμH}
						{\xx{rev}&\·\xx{all}&\xx{1sg.o}&\xx{qual}&\xx{gcnj}&\xx{irr}&\xx{mod}&\xx{mid}&\rt[¹]{move·around}&\·\xx{var}}
				\versus \vbform{át haa kawdiyáa}{pfv}[obj intr, \fm{∅}, mot]{we travelled there}
				\parencite[233.3319]{story-naish:1973}
					\vbmorph{á&-t&haa=&ka-&w-&d-&i-&\rt[¹]{ÿa}&-μμH}
						{\xx{3n}&\·\xx{pnct}&\xx{1pl.o}&\xx{qual}&\xx{pfv}&\xx{mid}&\xx{stv}&\rt[¹]{move.around}&\·\xx{var}}
			\end{itemize}
...
\item[ḵúx̱de=]\label{m:ḵúx̱de=}
	...
	Derived from \fm{ḵux̱=} and the allative postposition \fm{-de}.
	As detailed under \X{ḵux̱=}, \fm{ḵúx̱de=} occurs as part of the regular alternation
		between the punctual postposition \fm{-t} ‘at, to, around’,
		the pertingent postposition \fm{-x̱} ‘at, of, contacting’,
		and the allative postposition \fm{-dé} \~\ \fm{-de} ‘to, toward’
		that arises from the motion derivation
		\motderiv{NP-t/x̱/dé}{∅, \fm{-μμL} rep}{arriving at NP}.
	Based on this motion derivation, the \fm{ḵúx̱de=} form is expected
		with progressive and prospective aspect forms,
		and otherwise \fm{ḵux̱=} is expected
		(since neither \fm[*]{ḵux̱t} nor \fm[*]{ḵux̱x̱} occur).
	But there are also cases of \fm{ḵúx̱de=} with aspects other than progressive and prospective
		which have yet to be completely explained.
	\begin{enumerate}
	\item	With forms that have the progressive or prospective aspects,
			where \fm{NP-dé} would be predicted by the motion derivation
			\motderiv{NP-t/x̱/dé}{∅, \fm{-μμL} rep}{arriving at NP}
			so that \fm{ḵúx̱de=} is expected.
		\begin{enumerate}
		\item	With progressive aspect forms.
			\begin{itemize}
			\item	\vbform{ḵúx̱de yaa nalhásh}{prog}[obj intr, \fm{∅}, mot]{he’s floating back}
				\parencite[93.1184]{story-naish:1973}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&ÿaa=&na-&d-&l-&\rt[¹]{hash}&-μH}
						{\xx{rev}&\·\xx{all}&along&\xx{ncnj}&\xx{mid}&\xx{xtn}&\rt[¹]{float}&\·\xx{var}}
			\item	\vbform{du daaxʼ ḵúx̱de yaa x̱at tukandagásʼ}{prog}{I was starting to open up to him}
				\parencite[138.803]{nyman-leer:1993}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&ÿaa=&x̱at=&tu-&ka-&n-&da-&\rt[¹]{gasʼ}&-μH}
						{\xx{rev}&\·\xx{all}&along&\xx{1sg.o}&inside&\xx{qual}&\xx{ncnj}&\xx{mid}&\rt[¹]{move.end}&\·\xx{var}}
			\item	\vbform{du néegu ḵúx̱de yóo yaa ndaneen}{prog}{his sickness is slacking off right now}
				\parencite[194.2702]{story-naish:1973}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&yóo=&ÿaa=&n-&da-&\rt[¹]{niᴸ}&-μμL&-n}
						{\xx{rev}&\·\xx{all}&off&along&\xx{ncnj}&\xx{mid}&\rt[¹]{happen}&\·\xx{var}&\·\xx{nsfx}}
			\end{itemize}
		\item	With prospective aspect forms.
			\begin{itemize}
			\item	\vbform{wáa sáyá déis ḵúx̱de kḵwadagóot?}{prosp}{how am I going to go back now?}
				\parencite[6.94]{nyman-leer:1993}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&k-&ʷ-&g̱-&x̱a-&da-&\rt[¹]{gut}&-μμH}
						{\xx{rev}&\·\xx{all}&\xx{gcnj}&\xx{irr}&\xx{mod}&\xx{1sg.s}&\xx{mid}&\rt[¹]{go.\xx{sg}}&\·\xx{var}}
			\end{itemize}
		\end{enumerate}
	\item	With forms that have other aspects
			where \fm{NP-t} or \fm{NP-x̱} would be predicted by the motion derivation
			\motderiv{NP-t/x̱/dé}{∅, \fm{-μμL} rep}{arriving at NP}
			so that \X{ḵux̱=} is expected but \fm{ḵúx̱de=} occurs instead.
		\begin{enumerate}
		\item	With perfective aspect forms.
			\begin{itemize}
			\item	\vbform{ḵúx̱de yan wujiḵáḵ}{pfv}[subj intr, \fm{∅}, mot]{he squatted back}
				\parencite[207.2893]{story-naish:1973}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&ÿan=&wu-&d-&sh-&i-&\rt[¹]{ḵaḵ}&-μH}
						{\xx{rev}&\·\xx{all}&ground&\xx{pfv}&\xx{mid}&\xx{pej}&\xx{stv}&\rt[¹]{squat}&\·\xx{var}}
			\item	\vbform{kʼeeljáa ḵúx̱de yóo wdinee}{pfv}{the storm slacked off}
				\parencite[74.2701]{story-naish:1973}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&yóo=&w-&d-&i-&\rt[¹]{niᴸ}&-μμL}
						{\xx{rev}&\·\xx{all}&off&\xx{pfv}&\xx{mid}&\xx{stv}&\rt[¹]{happen}&\·\xx{var}}
			\item	\vbform{ḵúx̱dei s ayawdli.át yándei}{pfv}{they turned back toward land}
				\parencite[88.131]{dauenhauer-dauenhauer:1987}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&s=&a-&ÿa-&w-&d-&l-&i-&\rt[¹]{.at}&-μH}
						{\xx{rev}&\·\xx{all}&\xx{pl}&\xx{ind.h.s}&\xx{qual}&\xx{pfv}&\xx{mid}&\xx{xtn}&\xx{stv}&\rt[¹]{go.\xx{pl}}&\·\xx{var}}
			\item	\vbform{ḵúx̱de yóo s awsinee}{pfv}{they slowed down doing it (drinking)}
				\parencite[194.592]{nyman-leer:1993}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&yóo=&s=&a-&w-&s-&i-&\rt[¹]{niᴸ}&-μμL}
						{\xx{rev}&\·\xx{all}&off&\xx{plh}&\xx{3>3}&\xx{pfv}&\xx{csv}&\xx{stv}&\rt[¹]{happen}&\·\xx{var}}
			\end{itemize}
		\item	With other aspect forms.
			\begin{itemize}
			\item	\vbform{tléil ḵúx̱de akwdadzéey}{neg impfv}{he doesn’t draw back}
				\parencite[194.885]{story-naish:1973}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&a-&k-&ʷ-&da-&\rt[¹]{dziᴴÿ}&-μμH}
						{\xx{rev}&\·\xx{all}&\xx{xpl}&\xx{qual}&\xx{irr}&\xx{mid}&\rt[¹]{balk}&\·\xx{var}}
			\item	\vbform{ḵúx̱de ḵundaháa}{csec}{spring finally returned}
				\parencite[176.208]{dauenhauer-dauenhauer:1987}
					\vbmorph{\gm{ḵúx̱}&\gm{-de=}&ḵu-&n-&da-&\rt[¹]{haᴸ}&-μμH}
						{\xx{rev}&\·\xx{all}&\xx{areal}&\xx{ncnj}&\xx{mid}&\rt[¹]{appear}&\·\xx{var}}
			\end{itemize}
		\end{enumerate}
	\item	Used without a verb in contexts that usually suggest either ellipsis of the verb
			or some kind of nonverbal predication.
		See \X{ḵux̱=} for details.
		\begin{itemize}
		\item	\fm{Yáadáx̱ áwé tsu tle ḵúx̱de} ‘From here [we would go] back again’
			\parencite[212.956]{nyman-leer:1993}
		\end{itemize}
	\item	As a part of some nouns and adverbs.
		See \X{ḵux̱=} for details and a complete list.
	\end{enumerate}
