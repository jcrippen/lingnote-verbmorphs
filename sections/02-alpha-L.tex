...
\item[-l]\label{m:-l}
	...
	\item	nouns with a frozen \fm{-l} suffix
		...
		\item	\fm{x̱ákwl} ‘grappling hook (orig. made of eagle claw)’
			from \fm{\rt{x̱akw}} ‘nail, claw’
				\vbmorph{\rt{x̱akw}&-μH&-\gm{l}}
					{\rt{claw}&\·\xx{var}&\·\xx{inst}}
			\newline
			compare \fm{x̱aakw} \~\ \fm{x̱aagú} ‘(finger, toe) nail, claw’ and
				\vbform{áx̱ wudlix̱ákw}{pfv}[subj intr, \fm{∅}, mot?]{she/he/it hung there by nails/claws}
		\end{itemize}
	\end{enumerate}
