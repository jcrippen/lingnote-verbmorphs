...
Because of significant overlap and dialect variation, the two letters \fm{y} and \fm{ÿ} are not distinguished in order, so for example \fm{ÿa} precedes \fm{ye} precedes \fm{ÿi}.
...
There are a large number of morphemes beginning with \fm{s} so this has been split into separate sections for \fm{s} and \fm{sh}.
...
This \fm{∅} is not actually a morpheme but rather a label for the set of verbs that lack \fm{n-}, \fm{g̱-}, or \fm{g-} in certain forms where one would otherwise be expected.
For example, compare the imperative of the \fm{g} conjugation class verb based on \fm{\rt[²]{shi}} ‘sing’ in (\ref{ex:intro-null-morphemes-imp-sing}) with the imperative of the \fm{∅} conjugation class verb based on \fm{\rt[²]{x̱a}} ‘eat’ in (\ref{ex:intro-null-morphemes-imp-eat}).
In (\ref{ex:intro-null-morphemes-imp-sing}) the \X[g-conj]{g-} \~\ \X[ga-conj]{ga-} conjugation prefix appears, but in (\ref{ex:intro-null-morphemes-imp-eat}) there is no prefix at all.
 
\pex\label{ex:intro-null-morphemes-imp}%
\a\label{ex:intro-null-morphemes-imp-sing}%
\begingl
	\gla	\rlap{Gashí!} @ {} @ {} //
	\glb	ga- \rt[²]{shi} -μH //
	\glc	\xx{gcnj}\· \rt[²]{sing} \·\xx{var} //
	\gld	\rlap{it.\xx{imp}.you·\xx{sg}.sing} {} {} //
	\glft	‘Sing it!’
		//
\endgl
...
\begingl
	...
	\glb	\rt[²]{x̱a} -μH //
	\glc	\rt[²]{eat} \·\xx{var} //
	\gld	\rlap{it.\xx{imp}.you·\xx{sg}.eat} {} {} //
	\glft	‘Eat it!’
		//
\endgl
\xe
...
\begin{itemize}
\item	\vbform{at wutusixook}{pfv}[tr, \fm{g̱}, \fm{-μμL} act]{we dried something}
	\versus \vbform{wutusixook}{pfv}{we dried him/her/it}
\end{itemize}
...
\begin{itemize}
\item	\vbform{at wutusixook}{pfv}[tr, \fm{g̱}, \fm{-μμL} act]{we dried something}
	\versus \vbform{at wutuwax̱áa}{pfv}[tr, \fm{∅}, \fm{-μH} act]{we ate something}
\end{itemize}
...
\item[admon]	admonitive mood
		\hfill{}\X[u-irr]{u-}\fm{\xx{cnj}-}…\X{-μμH}
\item[cmpv]	comparative derivation
		\hfill{}\X[ka-cmpv]{ka-}\X[u-irr]{u-}…\X{-μμH}
\item[cond]	conditional mood
		\hfill{}\fm{\xx{cnj}-}\X[g̱-mod]{g̱-}…\X{-n}\X[-í-sub]{-í}
\item[csec]	consecutive aspect
		\hfill{}\fm{\xx{cnj}-}…\X{-μμH}
\item[ctng]	contingent mood
		\hfill{}\fm{\xx{cnj}-}\X[g̱-mod]{g̱-}…\X{-n}\X[-ín-ctng]{-ín}
\item[hab]	habitual aspect
		\hfill{}\fm{\xx{cnj}-}/\X[u-pfv]{u-}…\X{-ch}
\item[hort]	hortative mood
		\hfill{}\fm{\xx{cnj}-}…\X{-μμL}/\X{-μμH}\textsubscript*{∅⁺}
...
\item[pfv]	perfective aspect
		\hfill{}\X{wu-}/\X[u-pfv]{u-}
\item[pot]	potential mood
		\hfill{}\X[u-irr]{u-}\fm{\xx{cnj}-}\X[i-stv]{i-}…\X{-μμL}/\X{-μμH}\textsubscript*{∅⁺}
\item[prog]	progressive aspect
		\hfill{}\fm{\xx{pvb}=}\X{n-}…\X{-n}
\item[prosp]	prospective (‘future’) aspect
		\hfill{}\X[g-conj]{g-}\X[u-irr]{u-}\X[g̱-mod]{g̱-}…\X{-μμH}
\item[rel]	relative clause type
		\hfill{}\X[-i-rel]{-i} or none
\item[rep]	repetitive iterativity
		\hfill{}\X{-ch}, \X{-k}, \X{-x̱}, \X{-t}, \X{-tʼ}, \X{-xʼ}, \X{-sʼ}, \X{-lʼ}
\item[rlzn]	realizational aspect
		\hfill{}\fm{\xx{cnj}-}\X[i-stv]{i-}…\X{-μμH}
...
\item[\fm{\xx{cnj}-}]
		...
		one of the \fm{n-}, \fm{g̱-}, or \fm{g-} conj prefixes or nothing (\fm{∅})
			depending on conj class
\item[\fm{n}]	\fm{n} conjugation class\newline
		reflected by the presence of \fm{n-} conjugation prefix in imperative mood\newline
		and usually a repetitive imperfective with \fm{yoo=} … \fm{i-} … \fm{-k}
\item[\fm{g̱}]	\fm{g̱} conjugation class\newline
		reflected by the presence of \fm{g̱-} conjugation prefix in imperative mood\newline
		and the \fm{yei=} preverb in prospective or progressive aspect\newline
		and usually a repetitive imperfective with \fm{yei=} … \fm{-ch}
\item[\fm{g}]	\fm{g} conjugation class\newline
		reflected by the presence of \fm{g-} conjugation prefix in imperative mood\newline
		and the \fm{kei=} preverb in prospective or progressive aspect
		and usually a repetitive imperfective with \fm{kei=} … \fm{-ch}
\item[\fm{∅}]	\fm{∅} conjugation class\newline
		reflected by absence of a conjugation prefix in imperative mood\newline
		and usually a repetitive imperfective with \fm{-x̱}
\end{description}
