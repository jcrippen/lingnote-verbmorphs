...
\item[-álʼ]
	allomorph of repetitive suffix \fm{-lʼ} with epenthetic (filler) vowel \fm{á}

\item[-áḵw]
	allomorph of deprivative suffix \fm{-ḵ} \~\ \fm{-ḵw} with epenthetic (filler) vowel \fm{á}
...
\item[-ásʼ]
	allomorph of repetitive suffix \fm{-sʼ} with epenthetic (filler) vowel \fm{á}
...
\item[-átʼ]
	allomorph of repetitive suffix \fm{-tʼ} with epenthetic (filler) vowel \fm{á}
...
\item[-chʼ]
	unknown suffix;
	possibly a part of \fm{-chʼán} (with \fm{-án}) and \fm{-chʼálʼ} (with \fm{-álʼ}),
...
\item[chush=]
	allomorph of \fm{sh=} reflexive object
...
\item[d-, da-]
	...
	the \fm{…s} / \fm{…l} / \fm{…sh} forms must be preceded by a vowel,
		using epenthetic (filler) \fm{i} if no preceding prefixes end in a vowel,
		see those entries for examples
		(hypothetical \fm[*]{dza} / \fm[*]{dla} / \fm[*]{ja}
...
\item[-kw]
	allomorph of repetitive suffix \fm{-k} with labialization
...
\item[-kʼw]
	allomorph of diminutive suffix \fm{-kʼ} with labialization
...
\item[keeya]
	...
	combination of any prefix of the form \fm{ka-},
		\fm{μʷ-} perfective prefix,
		\fm{i-} second person singular subject,
		and \fm{ya-} stative prefix
	\begin{itemize}
...
\item[m-]
	...
	currently used instead of \fm{w-} only in Inland Tlingit varieties,
...
\item[-shán]
	allomorph of intensifier suffix \fm{-chʼán},
...
\item[wu-]
	...
	this prefix has a very complex phonology with many different patterns that depend on both
	preceding and following prefixes, see individual entries for details and verb prefix
	charts for comprehensive patterns;
	allomorphs:
	\begin{allolist}
	\item[m-]	coda consonant following a vowel, variant form of \fm{w-} used in Teslin
			and Carcross/Tagish varieties
	\item[u-]	special form only used with \fm{∅} conjugation class verbs
	\item[w-]	coda consonant following a vowel
	...
	\end{allolist}
	reconstructed as \fm[*]{ŋu-} \~\ \fm[*]{ŋ-} and cognate with Proto-Dene \fm[*]{ŋi-} perfective
