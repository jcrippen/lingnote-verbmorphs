...
\item[-tʼ]\label{m:-tʼ}
	...
	\item	in some complex nouns apparently derived from unknown verbs
		...
		\item	\fm{daakaleiltʼí} ‘husk, chaff, dried remains of berry’
			...
			\vbmorph{daa-&ka-&\rt{lel}&-μμL&-tʼ&-í}
		...
		\item	\fm{ḵʼalukakúltʼi} ‘slit, eyehole in thong end’
			...
			\vbmorph{ḵʼa-&lu-&ka-&\rt{kul}&-μH&-tʼ&-i}
	...
	\item	possibly analyzable in some CVCC nouns with coda /\ipa{tʼ}/
		...
		\item	\fm{shakalḵʼíshtʼ} ‘deer with four-point horns’
			perhaps from \fm{\rt{ḵʼish}} \~\ \fm{\rt{ḵʼesh}} ‘swat puck, ball’
		\end{itemize}
	\item	possibly part of two nouns ending with \fm{…tʼu}
		...
		\item	\fm{kéitʼu} ‘pick, pickaxe’ 
			...
			\fm{\rt{kitʼ}} ‘jam; pry’ and \fm{kítʼaa} ‘prybar’,
