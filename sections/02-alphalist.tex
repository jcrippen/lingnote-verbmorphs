...
\item[d-, da-]
	...
	\begin{itemize}
	\item	\fm{d-} alone is \fm{da} with an epenthetic (filler) vowel \fm{a}
	\item	\fm{d-} with \fm{i-} is \fm{di}
	\item	\fm{d-} with \fm{s-}/\fm{l-}/\fm{sh-} and \fm{i-}
			is \fm{dzi} / \fm{dli} / \fm{ji}
	\item	\fm{d-} is hidden with \fm{s-}/\fm{l-}/\fm{sh-} but no \fm{i-}
		\begin{itemize}
		\item	result is \fm{…s} / \fm{…l} / \fm{…sh}
		\item	predicted \fm[*]{dza} / \fm[*]{dla} / \fm[*]{ja}
...
\item[i-]
	...
	\item	second person singular оbject
		...
		\end{itemize}
	\item	ambiguous: either second person subject or object in certain imperfective verbs;
...
\item[-ḵ]
	...
	allomorphs:
		\fm{-ḵw} with labialization,
		\fm{-íḵ} \~\ \fm{-iḵ} with epenthetic (filler) vowel \fm{í} \~\ \fm{i},
		\fm{-úḵ} \~\ \fm{-uḵ} with epenthetic (filler) vowel \fm{í} \~\ \fm{i} and labialization;
	...
	\begin{enumerate}
	\item	optative with optative particle \fm{gu.aal} ‘hopefully’
			and usually also \fm{gushí} \~\ \fm{kwshé} ‘maybe’
	\item	prohibitive with prohibitive particle \fm{líl} ‘don’t’
...
\item[-ḵ]
	...
	allomorphs:
		\fm{-ḵw} with labialization,
		\fm{-áḵw} with epenthetic (filler) vowel \fm{á};
	contrast with optative/prohibitive \fm{-ḵ} which is accompanied by a particle;
