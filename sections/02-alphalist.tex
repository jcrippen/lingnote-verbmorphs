...
\item[-ch]\label{m:-ch}
	...
	\item	repetitive suffix in habitual aspect forms:
		\fm{\xx{cnj}-} … \fm{-ch} (\fm{n}, \fm{g̱}, \fm{g})
		or \X[u-pfv]{u-} … \fm{-ch} (\fm{∅})
		\begin{enumerate}
		\item	habitual forms of \fm{n}, \fm{g̱}, and \fm{g} conjugation class verbs
			...
			\item	habitual forms of \fm{n}/\fm{g̱}/\fm{g} conjugation class verbs
				...
				and \fm{-ch}
				\begin{itemize}
				\item	(find \rt{Ci} and/or \rt{Ce} example with \X{-μμH})
				\item	\fm{–géich}
			...
			\item	habitual forms of \fm{n}/\fm{g̱}/\fm{g} conjugation class verbs
				...
				\item	(\rt{Caᴸ} and/or \rt{Cuᴸ} example with \X{-μᵉμL})
				\end{itemize}
			\end{enumerate}
