...
\item[-ch]\label{m:-ch}
	...
	\item	\label{item:-ch-motderiv}
		...
		\item[\fm{∅}:]	\X[sha-head]{sha-}\X[ÿa-face]{ÿa-}\X[u-irr]{u-}…\fm{-ch}
		...
		\item	\label{item:-ch-motderiv-g}
			...
			these are distinct from the similar \fm{kei=…-ch}
				...
				\item	\fm{–ḵúx̱}
					...
					\newline
					using \motderiv{ḵut=}{\fm{g}, \fm{kei=…-ch} rep}{lost}
					\newline
				...
				\item	\fm{–téech}
					...
					\newline
					using \motderiv{NP-dáx̱}{\fm{g}, \fm{kei=…-ch} rep}{upward, starting from NP}
					\newline
		...
		\item	\label{item:-ch-motderiv-zdir}
			...
			\item	\fm{−x̱ʼílʼch}
				...
				\newline
				using \motderiv{yei=}{\fm{∅}, \fm{-ch} rep}{down, disembarking, exiting}
				\newline
			...
			\item	\fm{–.átch}
				...
				\newline
				using \motderiv{kei=}{∅, \fm{-ch} rep}{up}
				\newline
			...
			\item	\fm{–téech}
				from \fm{\rt[²]{ti}} ‘handle’
				\newline
				using \motderiv{daaḵ=}{\fm{∅}, \fm{-ch} rep}{inland, back from open, off fire}
				\newline
			...
			\item	\fm{–háshch}
				...
				\newline
				using \motderiv{daak=}{\fm{∅}, \fm{-ch} rep}{out to sea; into open; onto fire; precipitate}
				\newline
			...
			\item	\fm{–gútch}
				...
				\newline
				using \motderiv{ḵux̱(-dé) d-}{\fm{∅}, \fm{-ch} rep}{back, returning}
				\newline
	...
	\item	\label{item:-ch-hab}
		...
		there is some complexity in stem variation among habitual forms which is
			...
			\item	\fm{n}/\fm{g̱}/\fm{g} conjugation class patterns
				\begin{itemize}
				\item	\fm{\xx{cnj}-}\fm{\rt{CV⁽ᴴ⁾C⁽ʼ⁾}}\X{-μH}\fm{-ch}
					(\ref{item:-ch-hab-ng̱g-CVC})
				\item	\fm{\xx{cnj}-}\fm{\rt{CV}}\X{-μμH}/\X{-μᵉμH}\fm{-ch}
					(\ref{item:-ch-hab-ng̱g-CV})
				\item	\fm{\xx{cnj}-}\fm{\rt{CVᴸ}}\X{-μμL}/\X{-μᵉμL}\fm{-ch}
					(\ref{item:-ch-hab-ng̱g-CVL})
				\end{itemize}
			\item	\fm{∅} conjugation class patterns
				\begin{itemize}
				\item	\fm{\xx{dir}=}\X[u-pfv]{u-}\fm{\rt{CV⁽ᴴ⁾C⁽ʼ⁾}}\X{-μμL}/\X{-μμH}\fm{-ch}
					(\ref{item:-ch-hab-zdir-CVC})
				\item	\X[u-pfv]{u-}\fm{\rt{CV⁽ᴴ⁾C⁽ʼ⁾}}\X{-μH}\fm{-ch}
					(\ref{item:-ch-hab-zother-CVC-μH})
				\item	\X[u-pfv]{u-}\fm{\rt{CV⁽ᴴ⁾C⁽ʼ⁾}}\X{-μμL}/\X{-μμH}\fm{-ch}
					(\ref{item:-ch-hab-zother-CVC-μμL})
				\item	\X[u-pfv]{u-}\fm{\rt{CV⁽ᴸ⁾}}\X{-μμH}\X{-ÿ}\fm{-ch}
