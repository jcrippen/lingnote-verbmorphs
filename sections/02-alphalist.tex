...
\item[-t]\label{m:-t}
	...
	\item	in some complex nouns derived from verbs
		...
		\item	\fm{kax̱ʼeiltí} ‘crumbs’
			...
			\newline
			may instead be from contraction of \fm{eetí} ‘remains’
		\end{itemize}
...
\item[-tʼ]\label{m:-tʼ}
	...
	there may be a historical relationship 
		...
		since all of these are ejective
	\begin{enumerate}
	\item	repetitive suffix attested with nine roots,
		appearing in a repetitive imperfective form
		or in forms derived from the repetitive imperfective
			(secondary aspectual derivations, 
			\citeauthor{leer:1991}’s (\citeyear{leer:1991}) “epiaspect”);
...
\item[-xʼ]\label{m:-xʼ}
	...
	\item	repetitive suffix used with a wide variety of activity
		...
		\item	roots attested with \fm{-xʼ} \~\ \fm{-xʼw}
			...
			\end{inlinelist}
		\end{itemize}
	\item	repetitive suffix used in combination with \X{-x̱}
			in verbs based on \fm{\rt[²]{.u}} ‘put, place, leave’;
		it is unclear if this occurs with any other roots
		\begin{itemize}
		\item	\vbform{áa yéi du.úx̱xʼ}{rep impfv}[tr, \fm{n}, \fm{-μμL} act]{people put it there}
			...
			\versus \vbform{áa yéi na.oo}{imp}{put it there}
	...
	\item	plural suffix occurring together with deprivative \X[-ḵ-dprv]{-ḵ}
			with the roots \fm{\rt{tsin}} ‘strong’
			and \fm{\rt{ÿatʼ}} ‘long’;
		see \X[-ḵ-dprv]{-ḵ} for more details
	\item	plural suffix in some nouns derived from verbs
		\begin{itemize}
