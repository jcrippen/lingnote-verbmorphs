...
\item[-xʼ]\label{m:-xʼ}
	...
	may be glossed as plural \xx{pl} or repetitive \xx{rep};
	...
	\item	plural suffix used with dimensional state verbs when
		...
		does not occur when comparative derivation with comparative \X[ka-cmpv]{ka-}
			(which see for discussion of comparatives)
			and a plural object even though \X{d-} still occurs
		...
		\item	\vbform{a yáanax̱ koogéi}{impfv}[obj intr, \fm{g}, \fm{-μμH} state]{she/he/it is bigger than it}
			...
			\versus \vbform{a yáanáx̱ kudigéi}{impfv}{they are bigger than it}
				\vbmorph{k-&u-&d-&i-&\rt[¹]{ge}&-μμH&-xʼ}
					{\xx{cmpv}&\xx{irr}&\xx{mid}&\xx{stv}&\rt[¹]{big}&\·\xx{var}&\·\xx{pl}}
