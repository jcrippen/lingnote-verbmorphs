...
\item[d-]\label{m:d-}
	...
	alloforms:
	\begin{allolist}
	\item[di]	≡ \fm{d-i-} with stative \X[i-stv]{i-}
	\item[dli]	≡ \fm{d-l-i-} with valency \X{l-}/\X{lˢ-} and stative \X[i-stv]{i-}
	\item[dzi]	≡ \fm{d-s-i-} with valency \X{s-} and stative \X[i-stv]{i-}
	\item[ji]	≡ \fm{d-sh-i-} with valency \X{sh-} and stative \X[i-stv]{i-}
	\item[…l]	≡ \fm{d-s-} with valency \X{l-}/\X{lˢ-} (no \fm{i-})
	\item[…s]	≡ \fm{d-s-} with valency \X{s-} (no \fm{i-})
	\item[…sh]	≡ \fm{d-sh-} with valency \X{sh-} (no \fm{i-})
	\end{allolist}
