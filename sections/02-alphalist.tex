...
\item[d-, da-]
	...
	alloforms:
	\begin{allolist}
	\item[di]	≡ \fm{d-i-} with stative \fm{i-}
	\item[dli]	≡ \fm{d-l-i-} with valency \fm{l-}/\fm{lˢ-} and stative \fm{i-}
	\item[dzi]	≡ \fm{d-s-i-} with valency \fm{s-} and stative \fm{i-}
	\item[ji]	≡ \fm{d-sh-i-} with valency \fm{sh-} and stative \fm{i-}
	\item[…l]	≡ \fm{d-s-} with valency \fm{l-}/\fm{lˢ-} (no \fm{i-})
	\item[…s]	≡ \fm{d-s-} with valency \fm{s-} (no \fm{i-})
	\item[…sh]	≡ \fm{d-sh-} with valency \fm{sh-} (no \fm{i-})
	\end{allolist}
...
\item[ee]
	≡ \fm{a-i-}
	combination of argument marking \X{a-}
		and second person singular subject \X{i-}
...
\item[wu-]
	...
	\item[ÿ]	≡ \fm{ÿ-i-} with second singular subject \fm{i-}
	\item[ÿee]	≡ \fm{ÿ-i-μ-} with second singular subject \fm{i-}
			and stative \fm{μ-}
	\item[ÿeeÿ]	≡ \fm{ÿu-ÿi-} with second plural subject \fm{ÿi-}
	\item[ÿeeÿ]	≡ \fm{ÿu-ÿi-μ-} with second plural subject \fm{ÿi-}
			and stative \fm{μ-}
	\item[ÿeeÿCi]	≡ \fm{ÿu-ÿi-C-i-} with second plural subject \fm{ÿi-}
			and valency \fm{s-}/\fm{l-}/\fm{sh-}
			and stative \fm{i-}
	\item[ÿi]	≡ \fm{ÿ-i-} with second singular subject \fm{i-}
	\end{allolist}
	\begin{itemize}
