		...
		\item	verbs based on \fm{\rt[²]{.ax̱}} ‘hear’
			...
			\item	\fm{–.áx̱ch} ‘able to hear’
				...
				there are several aspect forms listed below that are documented
					...
					are suppleted by the \fm{∅} conjugation class verb
			...
			\item	\fm{–.áax̱ch} ‘learn speech’
				...
				\begin{itemize}
				\item	\vbform{awaa.áax̱ch}{pfv}{he learned it to the letter (by hearing over and over)}
					\parencites[02/170]{leer:1973}[116]{leer:1976}
