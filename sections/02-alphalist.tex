...
\item[-ch]\label{m:-ch}
	repetitive suffix
	\begin{enumerate}
	\item	repetitive suffix in conjugation class–predicted repetitive imperfective forms
		\begin{enumerate}
		\item	\fm{g̱} conjugation class repetitive imperfectives
			...
			\item	\fm{–shátch}
				...
				\versus \vbform{g̱alsháat!}{imp}{capture, hold down him/her/it!}
					\vbmorph{g̱a-&lˢ-&\rt[²]{shaᴴt}&-μμL}
						{\xx{g̱mod}&\xx{xtn}&\rt[²]{grab}&\·\xx{var}}
			\end{itemize}
		\item	\fm{g} conjugation class repetitive imperfectives
			with \X{kei=} ‘up’ and \fm{-ch}
			\begin{itemize}
			\item	\fm{–shátch}
				from \fm{\rt[²]{shaᴴt}} ‘grab’ in
				\newline
				\vbform{kei ashátch}{rep impfv}[tr, \fm{g}, ach]{she/he/it catches, grabs up him/her/it}
					\vbmorph{\gm{kei=}&a-&\rt[²]{shaᴴt}&-μH&\gm{-ch}}
						{up&\xx{3>3}&\rt[²]{grab}&\·\xx{var}&\·\xx{rep}}
				\versus \vbform{gasháat!}{imp}{catch, grab up him/her/it!}
					\vbmorph{ga-&\rt[²]{shaᴴt}&-μμL}
						{\xx{gcnj}&\rt[²]{grab}&\·\xx{var}}
			\end{itemize}
		\end{enumerate}
	\item	repetitive suffix in motion derivation provided repetitive imperfective forms
		\begin{enumerate}
		\item	\fm{g̱} conjugation class repetitive imperfectives
			with \X{yei=} ‘down’ and \fm{-ch}
			(same as lexically specified \fm{g̱} conjugation)
		\item	\fm{g} conjugation class repetitive imperfectives
			with \X{kei=} ‘up’ and \fm{-ch}
			(same as lexically specified \fm{g} conjugation)
		\item	\fm{∅} conjugation class repetitive imperfectives
			with \X{kei=} ‘up’, \X{yei=} ‘down’, \X{daaḵ=} ‘inland’,
				\X{daak=} ‘out to sea’, and \X{ḵux̱=} ‘back’
		\item	\fm{∅} conjugation class repetitive imperfectives
			with \X[ÿaa=along]{ÿaa=} ‘along’ \~\ \X[ÿa-face]{ÿa-} ‘face’ + irrealis \X[u-irr]{u-}
		\item	\fm{∅} conjugation class repetitive imperfectives
			with \X[sha-head]{sha-} ‘head’ + \X[ÿa-face]{ÿa-} ‘face’ + irrealis \X[u-irr]{u-}
		\end{enumerate}
	\item	repetitive suffix in unexpected repetitive imperfective forms
	\item	repetitive suffix in all habitual aspect forms,
		...
		\item	habitual forms of \fm{∅} conjugation class verbs
			...
			\end{enumerate}
		\end{enumerate}
	\item	semi-frozen repetitive suffix in forms from the secondary aspectual derivation
