...
\item[-áḵw]\label{m:-áḵw}
	...
	the \fm{-áḵw} form of the deprivative also appears in the stem
		...
		and \fm{-áḵw};
	finally, the \fm{-áḵw} suffix and its delabialized form \fm{-áḵ}
	...
	\item	\fm{gantáḵw} \~\ \fm{kantáḵw} ‘lupine’
		...
		(compare \fm{\rt{kan}} ‘dance in return’,
		\fm{kánaa} ‘flag, dance staff’,
		\fm{chookán} ‘grass’,
		\fm{keekán} ‘going to see’,
		\fm{g̱uwakaan} ‘deer’,
		\fm{káani} ‘sibling-in-law’)
	...
	\item	\fm{Tlʼanaxéedáḵw} ‘Property/Wealth Woman’
		from earlier \fm{Tlʼeinax̱xéedáḵw} \parencite{swanton:1909}
			\vbmorph{tlʼeiḵ&-náx̱&\rt{xit}&-μμL&\gm{-áḵw}}
