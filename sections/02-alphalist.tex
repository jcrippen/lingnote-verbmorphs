...
\item[-x̱]\label{m:-x̱}
	...
	\item	\label{item:-x̱-rep-motderiv}
		...
		only some \fm{∅} conjugation class motion derivations
			provide \fm{-x̱} repetitive imperfective forms and
			others instead provide repetitive imperfective forms with
				\X{-μμL},
				\X{-ch},
				or \X{-k}
		\begin{itemize}
