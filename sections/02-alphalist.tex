...
\item[-ch]\label{m:-ch}
	...
	\item	\label{item:-ch-hear}
		...
		verbs based on \fm{\rt[²]{.ax̱}} ‘hear’ with \fm{-ch} include states,
			...
			at least \fm{∅}, \fm{n}, and \fm{g̱} conjugation classes,
			and both stem forms \fm{–.áx̱ch} and \fm{–.áax̱ch}
			(the latter phonologically unexpected)
		\begin{enumerate}
		\item	verbs based on \fm{\rt[²]{.ax̱}} ‘hear’
			that have activity imperfectives with \fm{-ch}
		\item	verbs based on \fm{\rt[²]{.ax̱}} ‘hear’
			...
			\item	\fm{–.áx̱ch} ‘able to hear’
				...
				\newline
				\vbform{aya.áx̱ch}{rep impfv}[tr, \fm{g}, inv state]{she/he/it can hear him/her/it}
				...
				there are several aspect forms listed below that are documented
					for this verb which have \fm{-ch}, but other aspects
					(perfective, progressive, etc.)\ are suppleted by the 
					\fm{∅} conjugation class verb
				...
				\item	negative with extensional \X{lˢ-}
					...
					also means ‘she/he/it is deaf’
				\end{itemize}
			\item	\fm{–.áx̱ch} ‘understand’
				from \fm{\rt[²]{.ax̱}} ‘hear’
			\item	\fm{–.áx̱ch} ‘play instrument’
				from \fm{\rt[²]{.ax̱}} ‘hear’
			\item	\fm{–.áax̱ch} ‘learn speech’
				from \fm{\rt[²]{.ax̱}} ‘hear’
				(unexplained \fm{-μμH})
			\end{itemize}
		\item	verbs  based on \fm{\rt[²]{.ax̱}} ‘hear’
			that have \fm{-ch} in other aspects;
			these are probably from secondary aspectual derivations
				but it is unclear whether the underived base verbs
				are available, so they seem somewhat frozen
		\end{enumerate}
