...
\item[ach=]\label{m:ach=}
	...
	may reflect older forms of reflexive with affricate \fm{ch} (cf.\ \X{chush=})
		that otherwise became \fm{sh} (cf.\ \X{sh=}),
...
\item[-lʼ]
	...
	most often occurs with \fm{\rt[²]{xakw}} ‘whip up, beat (eggs, soapberries, etc.)’;
