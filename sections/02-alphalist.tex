...
\item[a-]\label{m:a-}
	...
	alloforms:
	\begin{allolist}
	\item[\X{aawa}]	≡ \fm{a-μʷ-wa-} combination with perfective \fm{μʷ-} and stative \fm{wa-} 
...
\item[aawa]\label{m:aawa}
	≡ \fm{\X{a-}μʷ-wa-}
	combination of argument marking \fm{\X{a-}},
		perfective \fm{μʷ-},
		and stative \fm{wa-};
	compare \fm{\X{awu}} ≡ \fm{\X{a-}wu-} and \fm{\X{aw}} ≡ \fm{\X{a-}w-}
	\begin{itemize}
