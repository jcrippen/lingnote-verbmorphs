...
\item[-áchʼ]\label{m:-áchʼ}
	...
	this \fm{-áchʼ} is attested only as a lexicalized element in the noun
		\fm{g̱eeg̱áchʼ} \~\ \fm{g̱eig̱áchʼ} ‘hammock, swing for baby’
		as well as verbs and nouns derived from this noun;
	...
	\item	possibly in \fm{tlʼaaḵʼwáchʼ} ‘sourdock, wild rhubarb (\textit{Rumex} spp.)’
		...
		although \textcite[79]{leer:1978} analyzes this with a stem \fm{ḵʼwáchʼ}
...
\item[-álʼ]\label{m:-álʼ}
	...
	\item	\vbform{anéegwálʼ}{impfv}[tr, \fm{n}, inv act]{she/he/it paints him/her/it}
		...
		\versus \vbform{yoo ayanéegwalʼk}{rep impfv}{she/he/it repeatedly paints him/her/it}
