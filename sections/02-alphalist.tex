...
\begin{morphdesc}[resume*=alphalist]
\item[-t]\label{m:-t}
	repetitive suffix describing repeated contact with a target;
	...
	\begin{enumerate}
	\item	repetitive suffix with any verb that denotes an event which involves
		...
		as with other repetitives there may be multiple entities involved (plural),
			...
			or both;
		\begin{itemize}
		\item	\vbform{a.únt}{rep impfv}[tr, \fm{∅}, ach]{she/he/it repeatedly shoots him/her/it (with gun)}
				\vbmorph{a-&\rt[²]{.un}&-μH&\gm{-t}}
					{\xx{3>3}&\rt[²]{shoot}&\·\xx{var}&\·\xx{ict}}
			\exand \vbform{aawa.únt}{rep pfv}{she/he/it shot him/her/it (with gun)}
				\vbmorph{a-&μʷ-&wa-&\rt[²]{.un}&-μH&\gm{-t}}
					{\xx{3>3}&\xx{pfv}&\xx{stv}&\rt[²]{shoot}&\·\xx{var}&\·\xx{rep}}
			\versus \vbform{a.únx̱}{rep impfv}{she/he/it is repeatedly shooting at him/her/it (with gun)}
				\vbmorph{a-&\rt[²]{.un}&-μH&-x̱}
					{\xx{3>3}&\rt[²]{shoot}&\·\xx{var}&\·\xx{rep}}
			\exand \vbform{aawa.ún}{pfv}{she/he/it shot him/her/it (with gun)}
				\vbmorph{a-&μʷ-&wa-&\rt[²]{.un}&-μH}
					{\xx{3>3}&\xx{pfv}&\xx{stv}&\rt[²]{shoot}&\·\xx{var}}
			\newline
			also noun \fm{óonaa} ‘rifle, gun’
		\item	\vbform{asʼélʼt}{rep impfv}[tr, \fm{n}, \fm{-μμH} act]{she/he/it repeatedly rips, tears him/her/it}
				\vbmorph{a-&\rt{sʼelʼ}&-μH&\gm{-t}}
					{\xx{3>3}&\rt{tear}&\·\xx{var}&\·\xx{ict}}
			\versus \vbform{asʼéilʼ}{impfv}{she/he/it is ripping, tearing him/her/it}
				\vbmorph{a-&\rt{sʼelʼ}&-μμH}
					{\xx{3>3}&\rt{tear}&\·\xx{var}}
			\newline
			also nouns \fm{sʼéilʼ} ‘rip, tear, wound’
				and \fm{sʼélʼ} ‘rubber’
		\item	attested roots include \parencite[532]{crippen:2019}:
			\begin{inlinelist}
			\item	\fm{\rt{chʼex̱ʼ}} ‘point’
			\item	\fm{\rt{dax̱}} ‘adze out’
			\item	\fm{\rt{dlakw}} ‘scratch’
			\item	\fm{\rt{dzuᴸ}} ‘throw missile’
