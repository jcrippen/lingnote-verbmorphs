...
\item[-x̱]\label{m:-x̱}
	...
	phonologically identical with the pertingent postposition \fm{-x̱} ‘of, contacting’
		and possibly from the same origin especially given the use of postposition \fm{-x̱}
	...
	\item	\label{item:-x̱-rep-roots}
		...
		\item	CVCC stems with possible frozen \fm{-x̱};
			excluding forms with \fm{…tx̱} [\ipa{tχ}] which are contractions
				of the postposition \fm{-dáx̱} ‘from’
			...
			\item	\fm{tlʼúkʼx̱} ‘worm, larva, caterpillar, snake’
			\item	\fm{shátx̱} ‘older sibling of woman’
			\end{itemize}
		\item	CVC roots and stems with possible frozen \fm{-x̱}
			\begin{itemize}
			\item	\fm{cháax̱} ‘horned or red-necked grebe’
			\item	\fm{chʼaḵúx̱} ‘skin canoe’
			\item	\fm{dáax̱} ‘unfinished canoe’
			\item	\fm{-dáx̱} ‘from’
			\item	\fm{eex̱} \~\ \fm{eix̱} ‘grease, oil’
			\item	\fm{goox̱} ‘slave’
			\item	\fm{\rt{g̱ax̱}} ‘cry’
				(noun \fm{g̱aax̱} ‘crying’)
			\item	\fm{g̱áx̱} ‘rabbit’
			\item	\fm{kooyéix̱} ‘whiskeyjack, camprobber, grey jay’
			\item	\fm{ḵaax̱} ‘merganser’
			\item	\fm{ḵʼanoox̱} ‘labret’
			\item	\fm{ḵukatáx̱} ‘dew, water drops on plants’
			\item	\fm{laax̱} ‘red-cedar’
			\item	\fm{lawúx̱} ‘immature gull’
			\item	\fm{\rt{lax̱}} ‘die (tree, bush)’
				(noun \fm{láax̱} ‘standing dead tree’)
			\item	\fm{leitóox̱} ‘throat’
			\item	\fm{\rt{lʼex̱}} ‘dance’
				(noun \fm{alʼeix̱} ‘dance’)
			\item	\fm{lóox̱} ‘whitefish’
			\item	\fm{-náx̱} ‘along, via, through’
			\item	\fm{…náx̱} ‘kind of bay’
			\item	\fm{\rt{nix̱}} \~\ \fm{\rt{nex̱}} ‘safe, rescued’
				(noun \fm{g̱aneix̱} ‘recovery, salvation’)
			\item	\fm{sʼaax̱} ‘marmot, groundhog, whistler’
			\item	\fm{sʼíx̱} \~\ \fm{sʼéx̱} ‘poison hemlock’
			\item	\fm{shaax̱} ‘grey currant’
			\item	\fm{sóox̱} ‘early, ahead’
			\item	\fm{téix̱} ‘boiled food’
			\item	\fm{tʼeix̱} ‘fishhook’
			\item	\fm{tlaax̱} ‘mould; ashen, pale’
			\item	\fm{tlʼéx̱} ‘usnea, brown tree lichen’
			\item	\fm{tleix̱} ‘forever, always (future)’
			\item	\fm{tlóox̱} ‘mud bullhead’
			\item	\fm{tsóox̱} ‘barricade’
			\item	\fm{oox̱} ‘tooth’
			\item	\fm{xʼéix̱} ‘king or spider crab’
			\item	\fm{xwéix̱} ‘steambath’
			\item	\fm{x̱éex̱} ‘boreal or saw-whet owl’
			\item	\fm{x̱úx̱} ‘husband’
			\item	\fm{ÿaax̱} ‘side of, shoreline of’
			\item	\fm{ÿáx̱} ‘like, similar’
