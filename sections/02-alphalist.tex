...
\item[-aa]\label{m:-aa}
	...
	\item	instrument suffix retained in verbs derived from nouns with this suffix;
		...
		\end{itemize}
	\item	instrument suffix in verbs with the ‘pretend activity’ derivation
			made up of:
			reflexive \X{ash=} \~\ \X{ach=}
			+ qualifier \X[ka-qual]{ka-}
			+ irrealis \X[u-irr]{u-}
			+ valency \X{s-}/\X{lˢ-} or \X{l-} or pejorative \X{sh-}
			± instrument \fm{-aa}
		...
		\end{itemize}
	\item	instrument suffix in verbs with the ‘miss target’ derivation made up of:
		qualifier \X[ÿa-qual]{ÿa-}
		+ valency \X{s-}/\X{lˢ-}
		+ repetitive \X{-x̱}
		+ instrument \X{-aa} \~\ \X{-áa}
		...
		\item	\vbform{ayawsi.únx̱aa}{pfv}[tr, \fm{∅}, ach]{she/he/it shot at him/her/it and missed}
				\vbmorph{a-&\gm{ÿa-}&w-&\gm{s-}&i-&\rt[²]{.uᴴn}&-μH&\gm{-x̱}&\gm{-aa}}
					{\xx{3>3}&\xx{qual}&\xx{pfv}&\xx{xtn}&\xx{stv}&\rt[²]{shoot}&\·\xx{var}&\·\xx{rep}&\·\xx{inst}}
