...
%% Memman p. 80 has the following sketch of the part commands:
%%
%% \newcommand{\part}[1]{%
...
%% The font command for the number of the part.
\renewcommand{\partnumfont}{\normalfont\sffamily\huge}

%% The font command for the name of the part (e.g. "Part").
\renewcommand{\partnamefont}{\normalfont\sffamily\huge}

%% The font command for the title of the part.
...
%% Open each chapter on a recto (right-hand, odd) page.
\openright

%% Chapter style. Adapted from wilsondob style included with memoir.
%% See memman.pdf §6.5 (p. 86).
\makechapterstyle{mine}{%
  % Space before the chapter label.
  \setlength{\beforechapskip}{2\onelineskip}%
  % Space after the chapter label.
  \setlength{\afterchapskip}{4\onelineskip plus 0.1\onelineskip
                             minus 0.167\onelineskip}%
  % How to print the name of the chapter (e.g. "Chapter", "Appendix").
  \renewcommand*{\printchaptername}{}%
  % Spacing or other things to print between the name and number.
  \renewcommand*{\chapternamenum}{}%
  % The font command for the number of the chapter.
  \renewcommand*{\chapnumfont}{\normalfont\sffamily\Huge\itshape}%
  % How to print the number of the chapter.
  \renewcommand*{\printchapternum}{\raggedleft\chapnumfont \thechapter\quad}%
  % What to print after the number of the chapter.
  \renewcommand*{\afterchapternum}{}%
  % The font command for the title of the chapter.
  \renewcommand*{\chaptitlefont}{\chapnumfont}%
  % Used when a chapter does not have a number (e.g. \frontmatter).
...
\newcommand{\secstylefont}{\sffamily}
%\newcommand{\subsubsecstylefont}{\rmfamily\addfontfeatures{Letters=Uppercase,Numbers=Lining}}
\newcommand{\subsubsecstylefont}{\sffamily}
...
\setsubsubsecheadstyle{\subsubsecstylefont\normalsize\raggedright}
\setparaheadstyle{\subsubsecstylefont\normalsize\raggedright}
\setsubparaheadstyle{\subsubsecstylefont\normalsize\raggedright}
