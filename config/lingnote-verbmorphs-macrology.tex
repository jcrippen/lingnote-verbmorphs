...
%% FIXME: The hyphenpenalty is a hack to deal with a bug in XeTeX. Delete when fixed.
\ProvideDocumentCommand \vbmorph {m m}
	{\lindent{with~}%
	\begin{tblr}{baseline=T, rowsep=0.0625ex, colsep=0.375ex,
		row{1} = {font=\itshape, cmd=\exhyphenpenalty10000},
		row{2} = {font=\romancondensedfont\small}}
	#1\\
	#2\\
	\end{tblr}}
