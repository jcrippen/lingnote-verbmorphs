...
\item[aawa]
	...
	combination of \fm{a-} argument marking prefix,
		\fm{μʷ-} perfective prefix,
		and \fm{wa-} stative prefix
	\begin{itemize}
	\item	\vbform{aawajáḵ}{pfv}[tr, \fm{∅}, ach]{s/he/it killed him/her/it}
...
\item[at=]
	...
	derived from the noun \fm{át} ‘thing’ (compare \fm{wé át} ‘that thing’);
...
\item[awu]
	...
	\item	\fm{tléil awux̱á} (neg pfv; tr, \fm{∅}, \fm{-μH} act) ‘s/he/it didn’t eat him/her/it’
		...
		\versus{\fm{aawax̱áa} (pfv) ‘s/he/it ate him/her/it’}
			\morphemes{\fm{a-μʷ-wa-\rt[²]{x̱a}-μμH}
				using \fm{wa-} stative}
...
\item[d-, da-]
	...
	\begin{itemize}
	\item	the \fm{da} form is \fm{d-} with an epenthetic (filler) vowel \fm{a}
		to fill out a syllable when the \fm{i-} prefix is not present
	\end{itemize}
	\begin{enumerate}
	\item	middle voice
	\item	passive voice
...
\item[wu-]
	perfective prefix;
	allomorphs include \fm{m-}, \fm{w-}, \fm{μʷ-},
