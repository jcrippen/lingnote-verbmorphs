...
A root represented as \fm{\rt{CVʰ}} in \cite{crippen:2019} is here given as \fm{\rt{CVᴸ}} and a root represented as \fm{\rt{CVʼC}} in \cite{crippen:2019} is here given as \fm{\rt{CVᴴC}}.
This representation is iconically closer to the actual tone patterns in Northern Tlingit varieties.

For the case of \fm{\rt{CVʼC}} → \fm{\rt{CVᴴC}}, compare the two roots \fm{\rt{xit}} ‘scratch’ and \fm{\rt{siᴴt}} ‘braid’ (formerly \fm{\rt{siʼt}}).
The affirmative perfective forms in (\ref{ex:intro-root-xit-uH}) and (\ref{ex:intro-root-sit-uH}) both have a stem with a short vowel and high tone \fm{-μH}.
The negative perfective form for \fm{\rt{xit}} in (\ref{ex:intro-root-xit-uuL}) has the predicted stem with a long vowel and low tone \fm{-μμL}.
...
The prospective forms in (\ref{ex:intro-root-ta-uuH}) and (\ref{ex:intro-root-ta-uuH}) both have a stem with a long vowel and high tone \fm{-μμH}.
...
But the stem of \fm{\rt{taᴸ}} with \fm{-μₑμL} in (\ref{ex:intro-root-ta-ueuH}) has low tone rather than high tone.
